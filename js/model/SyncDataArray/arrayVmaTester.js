function arrayVmaTester()
{
    ...
    arrayVmaTester.push(`${Translate.translate('Название проекта')}:${str}<br>Test started:${new Date().toLocaleString()}
                          <br><span id="insert_time"></span><br>
    ...
    arrayVmaTester.push(Translate.translate('Наклейка на дверях "Опасное напряжение"')); 
    ...
    arrayVmaTester.push(Translate.translate('Зуги повернуты открытой частью в одну сторону - нет замыкания между ними.'));
